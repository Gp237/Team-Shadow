import success_image from "../../assets/icon/pngtree-check-mark-icon-design-template-vector-isolated-png-image_711429.jpg";
        ...
        {!deleteModal ? (
          <>
            <div className="status_icon">
              <img src={img ? success_image : danger} alt="icon_status" />
            </div>
